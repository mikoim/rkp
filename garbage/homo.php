...
<head>
    ...
    <meta name="description" content="弁当チェーン「ほっともっと」のコスパランキング">
    <meta name="keywords" content="同志社大学,講義,評価,楽勝科目,楽勝般教,弁当,コスパランキング,本家かまどや,ほっともっと">
    <title>RKP - 「ほっともっと」 コスパランキング</title>
...
<div class="container-fluid">
    <div class="panel panel-default">
        <div class="panel-heading">「ほっともっと」 コスパランキング</div>
        <div class="panel-body">
            <p>こちらのページに掲載されているのは<b>京都府</b>のメニューです.</p>
            <p>2014/04/18 (金) : 最新の情報にアップデートしました.</p>
        </div>
        <div class="table-responsive">
            <table class="table table-condensed table-hover table-striped">
                ...
                foreach ($bentos as $bento) {
                    printf('<tr><td>%d</td><td>%s</td><td>%d 円</td><td>%.2f kcal</td><td>%.2f g</td><td>%.2f g</td><td>%.2f g</td><td>%.2f g</td><td>%.2f mg</td><td>%.2f mg</td><td>%f kcal/円</td></tr>',
                        $i, $bento['name'], $bento['price'], $bento['label'][0], $bento['label'][1], $bento['label'][2], $bento['label'][3], $bento['label'][4], $bento['label'][5], $bento['label'][6],$bento['kbs']);
                    $i++;
                }
